...
- `src/practiceEngine.ts` owns scoring, adaptive weighting, session summaries, trend summaries, mastery states, practice-plan recommendations, and analytics helpers. It is pure TypeScript and does not depend on React or browser storage.
