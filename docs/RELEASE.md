...
- Whether root project license, package license metadata, user-facing terms, privacy-policy hosting, contributor-community expectations, or code-of-conduct expectations changed intentionally and with owner approval.
