...
- Repository and documentation contracts: `npm run repo:hygiene`, `npm run docs:check`, `npm run adr:check`, `npm run product:check`, `npm run review:check`, `npm run dependencies:check`, `npm run architecture:check`, `npm run data:check`, `npm run design:check`, `npm run accessibility:check`, `npm run testing:check`, and `npm run release:notes` own foundation drift.
