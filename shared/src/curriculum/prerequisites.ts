...
export const PREREQUISITES: Readonly<Record<CompetencyId, readonly CompetencyId[]>> = {
  ...
  "ear.chord.quality": ["ear.interval.melodic"],
  "ear.scale.mode": ["ear.interval.melodic"],
  "ear.key.centre": ["ear.scale.mode"],
  "ear.cadence": ["ear.chord.quality"],
  "ear.rhythm.echo": ["rhythm.pulse"],
